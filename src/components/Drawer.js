                    ...
                    <List>
                        {['Dashboard', 'Requisitions', 'Stock', 'Calender', 'Reports'].map((text, index) => (
                            <ListItem button component={Link} to={text} key={text}>
                                <ListItemIcon>{React.cloneElement(icons[index], pathname.endsWith(text) ? { color: 'primary' } : {})}</ListItemIcon>
                                <ListItemText primary={text} primaryTypographyProps={pathname.endsWith(text) ? { color: 'primary' } : {}} />
                            </ListItem>
                        ))}
                    </List>
                </Drawer>
